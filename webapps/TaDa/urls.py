...
urlpatterns = patterns('',
	...
	url(r'^cast-list/(?P<movie_id>\d+)$','TaDa.views_more.cast_list'),
	url(r'^review-list/(?P<movie_id>\d+)$','TaDa.views_more.review_list'),
	url(r'^people-also-liked-list/(?P<movie_id>\d+)$','TaDa.views_more.people_also_liked_list'),
	url(r'^people-who-liked-list/(?P<movie_id>\d+)$','TaDa.views_more.people_who_liked_list'),
